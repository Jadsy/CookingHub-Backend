"""
Django settings for cookinghub project.
...
CSRF_TRUSTED_ORIGINS = [' https://cookinghub-backend.azurewebsites.net']
...
WSGI_APPLICATION = 'cookinghub.wsgi.application'
